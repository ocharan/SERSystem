...
namespace SER.Models.DTO
{
  public class StudentDto
  {
    ...
    [StringLength(9, ErrorMessage = "La matrícula debe tener {2} carácteres.", MinimumLength = 9)]
    [RegularExpression(@"^[Ss]\d{8}$", ErrorMessage = "La matrícula debe iniciar con la letra S seguido de 8 dígitos.")]
