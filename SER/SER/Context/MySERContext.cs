...
namespace SER.Context
{
    public partial class MySERContext : DbContext
    {
        ...
        public virtual DbSet<AlumnoExperienciaEducativa> AlumnoExperienciaEducativas { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AlumnoExperienciaEducativa>(entity =>
            {
                entity.HasKey(e => new { e.AlumnoId, e.ExperienciaEducativaId });

                entity.ToTable("AlumnoExperienciaEducativa");
                ...
                entity.HasOne(d => d.Alumno)
                    ...
                    .HasConstraintName("FK_AlumnoExperienciaEducativa_Alumno");

                entity.HasOne(d => d.ExperienciaEducativa)
                    .WithMany(p => p.AlumnoExperienciaEducativas)
                    .HasForeignKey(d => d.ExperienciaEducativaId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_AlumnoExperienciaEducativa_ExperienciaEducativa");
            });
            ...
            modelBuilder.Entity<AlumnoTrabajoRecepcional>(entity =>
            {
                ...
                entity.HasOne(d => d.Alumno)
                    ...
                    .HasForeignKey(d => d.AlumnoId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_AlumnoTrabajoRecepcional_Alumno");
