...
public class Test42
{
    ...
    public void test42()
    {
        ...
        driver.FindElement(By.Id("btnEditarOrg$1014")).Click();
        driver.FindElement(By.Id("inputNombreOrganizacion")).Clear();
        driver.FindElement(By.Id("inputNombreOrganizacion")).SendKeys("Instituto de inteligencia artificial y fisica");
