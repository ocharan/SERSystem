...
public class Test32
{
    ...
    public void test32()
    {
        ...
        string nombreRecibido = driver.FindElement(By.Id("alertError")).Text;
        string nombreEsperado = "Error de registro El proyecto que intenta registrar ya existe";
        Assert.AreEqual(nombreEsperado, nombreRecibido);
    }
}