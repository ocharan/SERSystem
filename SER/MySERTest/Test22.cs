...
public class Test22
{
    ...
    public void test21()
    {
        ...
        driver.FindElement(By.Id("btnModificarCuerpo&1048")).Click();

        driver.FindElement(By.Id("input_nombreCuerpo")).Clear();
        driver.FindElement(By.Id("input_nombreCuerpo")).SendKeys("Cuerpo académico de ingeniería de software y tecnologias");
